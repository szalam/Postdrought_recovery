...
for(n in 1:20000){
  ...
  cum.gws.17.18.19 = data.frame(cbind(cum.gws.17.18.19, cum.gws.all.tmp))
}

cum.gws.17.18.19 = cum.gws.17.18.19[,-1]

# write.csv(cum.gws.17.18.19, paste0(wd$output, 'cum_GWS_',n,'iter_',tot.rep,'yrs_2017_2019_recovery.csv'))
write.csv(cum.gws.17.18.19, paste0(wd$output, 'cum_GWS_',n,'iter_',tot.rep,'yrs_2016_2019_recovery.csv'))
saveRDS(cum.gws.17.18.19, paste0(wd$output, 'cum_GWS_',n,'iter_',tot.rep,'yrs_2016_2019_recovery.rds'))
