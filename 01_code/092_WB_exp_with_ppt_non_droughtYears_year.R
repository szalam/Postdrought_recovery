...
cum.gws.avgYr = 0
yr.sel = c(2003:2006,2010:2011,2016,2017,2019)
tot.rep = 20
for(n in 1:20000){
...
write.csv(cum.gws.avgYr, paste0(wd$output, 'cum_GWS_',n,'iter_',tot.rep,'yrs_nonDrghtYr_recovery.csv'))
saveRDS(cum.gws.avgYr, paste0(wd$output, 'cum_GWS_',n,'iter_',tot.rep,'yrs_nonDrghtYr_recovery.rds'))
